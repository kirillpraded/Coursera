...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {		
		...
		if (offline) {
		    ...
		    earthquakesURL = "quiz1.atom";  // The same feed, but saved August 7, 2015
		}
		else {
	...
	private void printQuakes() 
	{
		...
		for (Marker cm : countryMarkers) { 
			...
			for(Marker k :quakeMarkers) {
				EarthquakeMarker em = (EarthquakeMarker)k;
				String country = (String)em.getProperty("country");
				System.out.println(country);
				if(em.isOnLand() && name.equals("China")) {
					quakeCounter++;
				}
		...
		for(Marker k :quakeMarkers) {
			...
			System.out.println("There are "+ CountQuakesInOcean + " quakes in ocean");
		}
